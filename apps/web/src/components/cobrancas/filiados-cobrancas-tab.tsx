...
import {
  Loader2, Search, Users, TrendingUp, TrendingDown, AlertTriangle,
...
/**
 * Aba "Filiados" — carnês e parcelas por filiado.
 * Conteúdo extraído da tela de Cobranças sem mudança de comportamento; a página
 * passou a ser um contêiner de abas quando entrou a conferência patronal.
 */
export function FiliadosCobrancasTab() {
