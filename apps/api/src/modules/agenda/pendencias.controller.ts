 ...
 *
 * Gate de AGENDA e não de processos: a faixa é sobre as atividades da pessoa.
 ...
 *
 * A identidade vem SEMPRE do token: esta rota não aceita o id de outra pessoa.
 */
@ApiTags('pendencias')
@ApiBearerAuth()
@Modulo('agenda')
...
export class PendenciasController {
  ...
  @Get()
  @ApiOperation({ summary: 'O que não pode esperar e depende de quem está pedindo, agora.' })
