...
describe('a matriz é a única política de módulo', () => {
   ...
   * inteiro e fundir dois cadastros de organização sem desfazer. A fila de
   * duplicados de FILIADOS esteve aqui em 15/09/2026 e virou o módulo
   * `duplicados`, que o Administrador delega.
   */
   ...
   * grupo (17/09) e o lote, devolver um par à fila, e desde 22/09 descartar o
   * grupo que só tem linha vazia de importação — e nenhuma outra.
   *
   * A CONTAGEM É O PONTO. Se alguém acrescentar uma sexta, este número muda e
   * o teste obriga a explicar por escrito qual é e por que ela pode apagar sem
   * passar pelo perfil.
   */
  it('as exclusões delegadas são cinco, todas na fila de duplicados', () => {
